...
Function ToggleAlignOnL4L5()
	...
	if (AlignOnL4L5)
		AlignOnL4L5 = 0
		Print "Next time analysis is run: Aligning on soma."
	else
		AlignOnL4L5 = 1
...
//	print NameOfWave(xWave),NameOfWave(yWave)
	...
	do
		...
		if (lastIndex!=V_minloc)
			...
			Abort "Algorithm is stuck at point "+num2str(lastIndex)
		endif
